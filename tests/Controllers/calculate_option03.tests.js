describe('Calculation of option3', function(){
    var $controller;
    ...
    it('should calculate', function(){
      ...
      scope.personalRate = { value: 60 };
      scope.extraLength = { value: 0.8 };

      // ((0.75+9.35)*0.8)*1.2*60
      // (Жилет под пиджак(0.75+9.35)x0.8)x1.2x60
      // Extra length index 0.8
      // Personal rate 60
      expect(scope.getTotal()).toEqual(582);
