describe('Calculation of option4', function(){
    var $controller;
    ...
    it('should calculate', function(){
      ...
      // ((3.35+33.66)*1 + (0.11+0.9)*2 + (0.11+0.9))*1.2*50
      // (Пальто, полупальто зимние(3.35+33.66)x1 + Рельефы(0.11+0.9)x2 + Выточки(0.11+0.9))x1.2x50
      expect(scope.getTotal()).toEqual(2402);
